<?php 
	include('../control/allNotificationValidation.php');
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="container pt-5 pb-4">
    	...
    	<?php
	        if ($notification_query->num_rows > 0) {
	        	echo "<table><thead><tr><th>Notifications</th><th>Date</th></tr></thead>
	                  <tbody id='data'>";
	        	while($row = $notification_query->fetch_assoc()) {
	        	   echo "<tr><td>".$row["notifications"]."</td><td>".$row["time"]."</td>";
	        	}
	        	echo "</tbody></table>";
	        }            
	        else {
