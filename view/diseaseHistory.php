<?php 
	include('../control/diseaseHistoryValidation.php');
?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="history_section mt-4 mb-4">
	    	...
	    	<?php
		        if ($userQuery->num_rows > 0) {
		        	echo "<table><thead><tr><th>Plant Name</th><th>Detection Date</th></tr></thead>
		                  <tbody id='data'>";
		        	while($row = $userQuery->fetch_assoc()) {
		        	   echo "<tr><td>".$row["disease_name"]."</td><td>".$row["disease_date"]."</td>";
		        	}
		        	echo "</tbody></table>";
		        }            
		        else {
